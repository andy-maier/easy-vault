...
"""
Sphinx config file for easy-vault project.
...
project = u'easy-vault'
#copyright = u''
author = u"Andreas Maier"

# The short description of the package.
_short_description = u"Secure vault files that are easy to use"
...
version = get_version(os.path.join('..', 'easy_vault', '_version.py'))
...
htmlhelp_basename = 'easy_vault_doc'
...
latex_documents = [
    (master_doc, 'easy_vault.tex', _short_description, author, 'manual'),
]
...
man_pages = [
    (master_doc, 'easy_vault', _short_description, [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'easy_vault', _short_description,
     author, 'easy_vault', _short_description,
     'Miscellaneous'),
]
