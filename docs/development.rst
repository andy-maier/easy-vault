...
This section only needs to be read by developers of the **easy-vault**
...
1. If you have write access to the Git repo of this project, clone it using
   ...
   .. code-block:: bash
        ...
        $ git clone git@github.com:andy-maier/easy-vault.git
        $ cd easy-vault
...
project package at https://easy-vault.readthedocs.io/
...
Python environment.
Depending on how the `easy-vault` package is installed in
...
This section describes how to release a version of **easy-vault**
to PyPI.
...
The description assumes that the `andy-maier/easy-vault`
Github repo is cloned locally and its upstream repo is assumed to have the Git
remote name `origin`.

Any commands in the following steps are executed in the main directory of your
local clone of the `andy-maier/easy-vault`
Git repo.
...
13. On ReadTheDocs, activate the new version ``M.N.U``:
    ...
    * Go to https://readthedocs.org/projects/easy-vault/versions/
      and log in.
    ...
    * Activate the new version ``M.N.U``.
      ...
      https://easy-vault.readthedocs.io/
...
14. Upload the package to PyPI:
    ...
    **Attention!** This only works once for each version. You cannot release
    ...
    https://pypi.python.org/pypi/easy-vault/
...
easy-vault project in its Git repo.
